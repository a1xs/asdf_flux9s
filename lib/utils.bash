...
GH_REPO="https://github.com/dgunzy/flux9s"
TOOL_NAME="flux9s"
TOOL_TEST="flux9s -version"
...
get_platform_old() {
  # The flux9s asset names used to use capitalized platform names (version 0.53.0 and earlier).
  local platform
